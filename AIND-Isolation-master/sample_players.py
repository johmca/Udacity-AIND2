...
def null_score(game, player):
    ...
    My translation is that it returns 0 for all non terminal states and
    for terminal states it will return -inf if the player has lost and
    +inf if the player has won
...
def open_move_score(game, player):
    ...
    My translation here is that in non terminal states the number of legal moves
    available to the player is returned.

    In terminal states we return -inf or + inf depending on whether the player has
    lost or won.
...
def improved_score(game, player):
    ...
    My translation here is that in non terminal states the number of legal moves
    available to the opponent is subtracted from the number of legal moves
    available to the player and the result of this is returned.
...
if __name__ == "__main__":
    ...
    print("Player 1 legal moves....",game.get_legal_moves())

...
#i) Apply eliminate and only choice constraints iteratively to the sudoku and optionally apply
#   constrainst to the diagonals if the sudoku type flag is 'D'
#ii)If not solved then apply search techniques to the suduko to try all remaining possibilities
    ...
    if solved_sudoku==False:
        ...
        #for k, v in solved_sudoku.items():
            #print(k,v)
